...
hl.bind(mainMod .. " + XF86AudioRaiseVolume", hl.dsp.exec_cmd("swayosd-client --brightness raise"), { repeating = true })
hl.bind(mainMod .. " + XF86AudioLowerVolume", hl.dsp.exec_cmd("swayosd-client --brightness lower"), { repeating = true })
